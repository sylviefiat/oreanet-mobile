var sql = {
	...
	SELECTidINSERT : "SELECT id FROM cot_admin where observer_name=? and observer_tel=? and observer_email=? and observation_date=? and observation_location=? and observation_localisation=? and observation_region=? and observation_country=? and observation_latitude=? and observation_longitude=? and observation_number=? and observation_culled=? and counting_method_timed_swim=? and counting_method_distance_swim=? and counting_method_other=? and depth_range=? and observation_method=? and remarks=? and date_enregistrement=?;",
	SELECTCOTLIST : "SELECT id, observation_date, observation_location, observation_localisation, observation_number, date_enregistrement FROM cot_admin where status<>'synchronized';",
	SELECTreditCOTForm : "SELECT id, observer_name, observer_tel, observer_email, observation_date, observation_location, observation_localisation, observation_region, observation_country, observation_latitude, observation_longitude, observation_number, observation_culled, counting_method_timed_swim, counting_method_distance_swim, counting_method_other, depth_range, observation_method, remarks FROM cot_admin WHERE id = ? ;",
