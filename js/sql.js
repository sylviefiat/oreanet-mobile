var sql = {
	...
	SELECTidINSERT : "SELECT id FROM cot_admin where observer_name=? and observer_tel=? and observer_email=? and observation_date=? and observation_location=? and observation_localisation=? and observation_region=? and observation_country=? and observation_latitude=? and observation_longitude=? and observation_number=?, observation_culled=? and counting_method_timed_swim=? and counting_method_distance_swim=? and counting_method_other=? and depth_range=? and observation_method=? and remarks=? and date_enregistrement=?;",
